...
SECRET_KEY = 'stqdrc87*m%^1%$gu)7)12ae13a%0-#89&%j23jp1)je3kvdob'
...
SASS_PROCESSOR_INCLUDE_DIRS = [
    os.path.join(BASE_DIR, 'node_modules/foundation-sites/scss'),
    os.path.join(BASE_DIR, 'node_modules/bootstrap/scss'),
    os.path.join(BASE_DIR, 'node_modules'),
]
